...
model = keras.models.load_model("LRCN_model___11_11_22___Accuracy_0.625__Loss__0.6375__250_10_aug.h5")
...
def system_loop(SEQUENCE_LENGTH):
    input_video_file_path = f'Violations/predict_video/T1Gun.mp4' 
